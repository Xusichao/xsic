...
import com.xsic.xsic.databinding.FragmentMineBinding;
import com.xsic.xsic.utils.LogUtil;

public class MineFragment extends BaseDataBindingFragment<FragmentMineBinding,MineViewModel> {
    @Override
    ...
    @Override
    protected void subscribeUi(MineViewModel viewModel) {
