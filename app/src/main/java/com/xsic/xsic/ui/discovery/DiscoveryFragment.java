...
import com.xsic.xsic.databinding.FragmentDiscoveryBinding;
import com.xsic.xsic.utils.LogUtil;

public class DiscoveryFragment extends BaseDataBindingFragment<FragmentDiscoveryBinding,DiscoveryViewModel> {
    @Override
    ...
    @Override
    protected void subscribeUi(DiscoveryViewModel viewModel) {
